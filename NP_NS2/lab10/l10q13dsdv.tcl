...
$node_(15) set X_ 1050.0
$node_(15) set Y_ 5.0
$node_(15) set Z_ 0.0

$node_(16) set X_ 1200.0
$node_(16) set Y_ 5.0
$node_(16) set Z_ 0.0

$node_(17) set X_ 1050.0
$node_(17) set Y_ 250.0
$node_(17) set Z_ 0.0

$node_(18) set X_ 1200.0
$node_(18) set Y_ 250.0
$node_(18) set Z_ 0.0

$node_(19) set X_ 600.0
$node_(19) set Y_ 127.0
$node_(19) set Z_ 0.0
...
$ns at 10.0 "$node_(0) setdest 500.0 127.0 5.0"

set udp1 [new Agent/UDP]
$ns attach-agent $node_(0) $udp1
set null1 [new Agent/Null]
$ns attach-agent $node_(18) $null1
